...
public class FileUtils {
     ...
     * @return 是否写入成功
     */
    public static boolean writeFile(byte[] content, String path, String fileName, boolean append) {
        boolean res = false;
    ...
    public static boolean writeFile(String content, String path, String fileName, boolean append) {
        return writeFile(content.getBytes(), path, fileName, append);
    }
